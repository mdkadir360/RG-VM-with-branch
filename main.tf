...
module "vnet" {
  source     = "github.com/mdkadir360/Terraform_Module_for_Branch//4-Virtual-network"
  vnet       = var.vnet
  depends_on = [module.Rg]
}
module "subnet" {
...
module "pip" {
  source     = "github.com/mdkadir360/Terraform_Module_for_Branch//6-Publicip"
  pip        = var.pip
  depends_on = [module.Rg]
}
module "nic" {
...
module "vm" {
  source     = "github.com/mdkadir360/Terraform_Module_for_Branch//10-Linuxvm"
  vm         = var.vm
